  ...
  try {
    ...
    csvtojson()
      ...
      .then(async (json) => {
        ...
        // const scoreTeacher = await Teacher.findOne(  {aicteScores: { $elemMatch:{year: 2022}  }},{fullName: teacherName});
        // console.log(scoreTeacher);
        // console.log(scoreTeacher);
        // const tr = scoreTeacher.teaching.find()
